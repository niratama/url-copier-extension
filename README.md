...
- **One-Click Copy**: Click the extension icon to copy using the last used format.
...
4.  **Left-click** the extension icon in the toolbar to quickly copy using the last selected template.
